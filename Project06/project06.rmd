...
def normalize_similarity_matrix(similarity_matrix: np.ndarray, seq_ids: List[str]) -> np.ndarray:
...
def build_distance_matrix(sequences: Dict[str, str], seq_ids: List[str]) -> Tuple[np.ndarray, List[str]]:
    """Builds distance matrix using Smith-Waterman scores.
    ...
    return 1 - normalized_sm, seq_ids
```
