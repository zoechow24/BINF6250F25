...
library('reticulate')
use_python("/Users/michaelbambha/Documents/school/binf6250/project06/.venv/bin/python")
```
...
def build_distance_matrix(sequences: Dict[str, str], metric="cosine") -> Tuple[np.ndarray, List[str]]:
    ...
    if metric not in DISTANCE_FUNCTIONS:
      raise ValueError(f"Unsupported metric: {metric}. Choose from one of {DISTANCE_FUNCTIONS.values()}")
...
def neighbor_joining(
    ...
    if len(nodes) == 2:
        ...
        nodes[1].add_edge(nodes[0], final_distance)
