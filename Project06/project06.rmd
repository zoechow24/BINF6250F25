...
def neighbor_joining(
    ...
    Examples:
        ...
        18
    """
    # seqs = read_fasta("lafayette_SARS_RT.fasta") # being read in the main
    # distance_matrix, seq_ids = build_distance_matrix(seqs) # already receiving distance_matrix and seq_ids
    n_taxa = distance_matrix.shape[0]
